...
INSERT INTO books (id, category_id, publisher_id, title, isbn, description, publish_year, language, pages, shelf_location, total_quantity, available_quantity, created_by) VALUES
(1, 1, 1, 'Mắt Biếc', 'ISBN001', 'Câu chuyện tình buồn thời học sinh', 1990, 'vi', 250, 'A1-01', 5, 3, 2),
(2, 2, 3, 'Harry Potter và Hòn đá Phù thủy', 'ISBN002', 'Cậu bé phù thủy nổi tiếng', 1997, 'en', 320, 'B1-02', 10, 7, 2),
(3, 2, 3, 'Kafka bên bờ biển', 'ISBN003', 'Tiểu thuyết siêu thực', 2002, 'jp', 400, 'B2-01', 4, 2, 2),
(4, 3, 1, 'Học Python cơ bản', 'ISBN004', 'Sách lập trình Python', 2020, 'vi', 350, 'C1-01', 6, 6, 2),
(5, 5, 2, 'Dế Mèn Phiêu Lưu Ký', 'ISBN005', 'Truyện thiếu nhi kinh điển', 1941, 'vi', 180, 'D1-01', 8, 5, 2);
